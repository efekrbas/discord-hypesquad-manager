# <img src="https://github.com/efekrbas/discord-hypesquad-manager/blob/main/images/logo.png" width="32" height="32" align="center"> Discord HypeSquad Badge Manager
...
1. Go to the **[Latest Release](https://github.com/efekrbas/discord-hypesquad-manager/releases/tag/v1.0.4)** page of this repository.
2. Download **`Discord HypeSquad Manager Setup v1.0.4.exe`** to install the app on your PC.
